...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            System.out.print("ЛР №3 Андреева 6413\n Меню\n\n" +
                    "1) создать базу\n" +
                    ...
                    "----------------------------------------------------------------------------------------\n"+
                    "7) отсортировать массив по возрастанию значения функционального метода\n"+
                    "8) отсортировать массив по убыванию значения функционального метода\n"+
                    "0) выйти\n\n" +
                    "Выберите пункт меню: ");
            menu = scan.nextLine();
            switch (menu) {
                ...
                case "7": {
                    System.out.println("отсортировать массив по возрастанию значения функционального метода\n");
                    GamesI[] arrSeries, arrCollections;
                    if (db == null) {
                        System.out.print("База данных не существует ");
                    }for (int i = 0; i < db.length; i++) {
                        int minIndex = i;
                        for (int j = i + 1; j < db.length; j++) {
                            if ((db[j].compareTo(db[minIndex])) < 0)
                                minIndex = j;
                        }
                        GamesI swapBuf = db[i];
                        db[i] = db[minIndex];
                ...
                case "8": {
                    ...
                    Comparator<GamesI> comparator = new GamesComparator();
                   /* for (int i = 0; i < db.length; i++) {
                        int maxIndex = i;
                        for (int j = i + 1; j < db.length; j++) {
                            if (comparator.compare(db[j], db[maxIndex]) > 0)
                                maxIndex = j;
                        }
                        GamesI swapBuf = db[i];
                        db[i] = db[maxIndex];
                    ...
                    */
                    ...
                    GamesComparator.sort(db,comparator);
                    break;
                }
                default:
                    System.out.println("Выбран неверный пункт меню");
