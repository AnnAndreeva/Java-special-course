...
public class GamesCollection implements GamesI {
    ...
    public void output(OutputStream out) {
        ...
        try {
            ...
            outputStream.writeUTF(this.titleOfGamesCollection);
            outputStream.writeInt(this.gamesInCollection.length);
            outputStream.writeInt(this.amountOfMissionsInPrologue);

            for(int i = 0; i < this.gamesInCollection.length; ++i) {
                outputStream.writeUTF(this.gamesInCollection[i]);
    ...
    public void write(Writer out) {
        ...
        printWriter.println(this.titleOfGamesCollection);
        printWriter.println(this.gamesInCollection.length);
        printWriter.println(this.amountOfMissionsInPrologue);

        for(int i = 0; i < this.gamesInCollection.length; ++i) {
            printWriter.println(this.gamesInCollection[i]);
